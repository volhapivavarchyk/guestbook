            ...
            <form method="post" action="" class="add-message" enctype="multipart/form-data">
                ...
                <div class="add-message-box-field">
                    <div class = "add-message-field">
                        ...
                        <textarea name="text" id="text" placeholder="содержание сообщения" rows="8" cols="46" pattern="[/<\/?[a-z][a-z0-9]*>/i]" required ></textarea><br />
                   ...
                   <?php foreach ($blockOfMessages as $message): ?>
                       <div class = "box-message">
                           <div class="title-message">
                               ...
                               <div style = "margin-left: auto;"><?= htmlentities($message['name']) ?></div>&nbsp;&brvbar;&nbsp;
                               <div><?= htmlentities($message['email']) ?></div>&nbsp;&brvbar;&nbsp;
                           ...
                           <div class="text-message">
                               ...
                               <p>
                                   ...
                                   <img class="example-image"  src="upload/img/small/<?= htmlentities($message['pictures'])?>" alt="<?= htmlentities($message['pictures'])?>" /></a>&nbsp;&brvbar;&nbsp;
                                   <a href = "<?= htmlentities($message['filepath']) ?>" type="application/file"><?= htmlentities(basename($message['filepath'])) ?></a>
                               </p>
                           </div>
                       </div>
                   <?php endforeach; ?>
