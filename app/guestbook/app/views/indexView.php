        ...
        <form method="post" action="" class="add-message" enctype="multipart/form-data">
            <div class="add-message-field">
                <div class="tooltip">
                    ...
                    <input type="text" name="name" id="name" placeholder="name" minlength="1" maxlength="150"
            ...
            <div class="add-message-box-field">
                <div class="add-message-field">
                    <div class="tooltip">
                        ...
                        <textarea name="text" id="text" placeholder="текст сообщения" rows="8" cols="46"
                                  pattern="[/<\/?[a-z][a-z0-9]*>/i]" required></textarea><br/>
                        <input type="button" value="link" onClick="formatTextArea('a')"
                               style="margin-left:205px; margin-top: 3px;"/>
            ...
            <div class="title-message">
                ...
                <div class="arrows-title-message">
                    <div><input type="image"
                                src=<?= $sort == "name_desc" ? "images/double-up.png" : "images/double-up-not.png" ?>  name
                        = "sort" value="name_desc" width="10" height="10"/></div>
                    <div><input type="image"
                                src=<?= $sort == "name_asc" ? "images/double-down.png" : "images/double-down-not.png" ?> name
                        = "sort" value="name_asc" width="10" height="10" /></div>
                </div>
                <h4 class="title-message-fields"> E-mail </h4>
                <div class="arrows-title-message">
                    <div><input type="image"
                                src=<?= $sort == "email_desc" ? "images/double-up.png" : "images/double-up-not.png" ?>  name
                        = "sort" value="email_desc" width="10" height="10"/></div>
                    <div><input type="image"
                                src=<?= $sort == "email_asc" ? "images/double-down.png" : "images/double-down-not.png" ?> name
                        = "sort" value="email_asc" width="10" height="10" /></div>
                </div>
                <h4 class="title-message-fields"> Дата добавления </h4>
                <div class="arrows-title-message">
                    <div><input type="image"
                                src=<?= $sort == "date_desc" ? "images/double-up.png" : "images/double-up-not.png" ?>  name
                        = "sort" value="date_desc" width="10" height="10"/></div>
                    <div><input type="image"
                                src=<?= $sort == "date_asc" ? "images/double-down.png" : "images/double-down-not.png" ?> name
                        = "sort" value="date_asc" width="10" height="10" /></div>
                </div>
            </div>
        </form>
        ...
        <?php if ($i == 1): ?>
            <div id="number<?= $i; ?>" style="color:#006699; font-size: 0.8em; font-weight: bold; ">
                ...
                <div id="number<?= $i; ?>" style="color:black; font-size: 0.8em; font-weight: bold;">
                    <?php endif; ?>
                    <a href=# onClick=viewMessages(<?= $i ?>,<?= $countOfMessages ?>)
                       style="color:unset; text-decoration:none;"><?= $i; ?></a>&nbsp;&nbsp;
                </div>
                <?php endfor; ?>
            </div>
                                ...
                                <?php if ($message['pictures'] || $message['filepath']): ?>
                                    <p style="padding: 2px; margin: 0px;">
                                        <?php if ($message['pictures']): ?>
                                            <a href="upload/img/<?= htmlentities($message['pictures']) ?>"
                                               class="example-image-link" data-lightbox="image-1">
                                                <img class="example-image"
                                                     src="upload/img/small/<?= htmlentities($message['pictures']) ?>"
                                                     alt="<?= htmlentities($message['pictures']) ?>"/></a>&nbsp;&nbsp;
                                        <?php endif; ?>
                                        <?php if ($message['filepath']): ?>
                                            <a href="<?= htmlentities($message['filepath']) ?>" type="application/file"
                                               style="text-decoration: none;"><?= htmlentities(basename($message['filepath'])) ?></a>
                                        <?php endif; ?>
                                    </p>
                                <?php endif; ?>
                            </div>
